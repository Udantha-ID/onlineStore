...
<?php
	...
	if(isset($_POST["submit"])){
        ...
        if ($result) {
            ...
            if($row['UserType'] == 'dvp'){
                echo "<script>window.location.replace('../Delivery_Person.html')</script>";	//go back to MainPage of delever page
            }
            else if($row['UserType'] == 'csr'){
                echo "<script>window.location.replace('../customer.html')</script>";		//go back to MainPage of customer page
            }
            else if($row['UserType'] == 'slr'){
                echo "<script>window.location.replace('../Seller.html')</script>";		//go back to MainPage of seller page
            }
